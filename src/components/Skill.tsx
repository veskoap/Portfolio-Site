...
function Skill({skill, directionLeft}: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      ...
      <div className="absolute opacity-0 group-hover:opacity-80 delay-700 transition duration-300 ease-in-out group-hover:bg-white w-16 h-16 md:h-24 md:w-24 rounded-full z-0">
