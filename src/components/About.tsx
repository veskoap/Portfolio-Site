...
export default function About({pageInfo}: Props) {
  return (
    ...
    >
      ...
      <div className='relative mx-auto pt-96 md:pt-0 -space-y-8 md:space-y-10 flex h-screen flex-col items-center justify-evenly text-center md:flex-row md:text-left'>
        <motion.div
