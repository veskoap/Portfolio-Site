...
export default function About({pageInfo}: Props) {
  return (
    ...
    >
      ...
      <div className='relative mx-auto pt-96 md:pt-0 -space-y-84 md:space-y-10 flex h-screen flex-col items-center justify-evenly text-center md:flex-row md:text-left'>
        <motion.div
        ...
        >
          <Image
            ...
            width={200}
            height={200}
            className=" flex max-w-[240px] h-48 w-48 md:h-56 md:w-56 xl:h-64 xl:w-64 flex-shrink-0 rounded-full scroll -pb-10 md:max-w-sm md:rounded"
          />
        </motion.div>
