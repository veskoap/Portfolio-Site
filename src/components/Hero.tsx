...
export default function Hero({pageInfo}: Props) {
  ...
  return (
    <div className="h-screen flex -mt-36 mb-36 pb-32 flex-col space-y-8 items-center justify-center text-center overflow-hidden">
      ...
      />
      <div className="z-20">
        <h2 className="text-sm uppercase text-gray-500 pb-2 tracking-[6px] md:tracking-[8px] lg:tracking-[10px]">{pageInfo?.role}</h2>
        <h1 className="text-xl lg:text-3xl xl:text-6xl font-semibold px-10">
