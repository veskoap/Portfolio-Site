...
export default function ExperienceCard({experience}: Props) {
  return (
    <article
      className="flex flex-col xl:mb-20 rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] md:w-[600px] xl:w-[800px] snap-center bg-[#292929] p-4 -mb-8 xl:p-10 hover:opacity-100 opacity-40
    ...
    >
      ...
      <div className="px-0 md:px-10">
        ...
        <p className="uppercase text-sm md:text-base py-3 md:py-5 text-gray-300">
